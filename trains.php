    					...
    					<form action="trainSearch.php" method="POST">
    						...
    						<div class="col-sm-6">			
   							<div class="form-group">
									...
									<option value="Chittagong" data-subtext="CGP" data-tokens="CGP Chittagong">Chittagong</option>
									<option value="Dhaka" data-subtext="DAC" data-tokens="DAC Dhaka">Dhaka</option>		
									<option value="Rajshahi" data-subtext="RAJ" data-tokens="RAJ Rajshahi">Rajshahi</option>      								
									<option value="Sylhet" data-subtext="ZYL" data-tokens="ZYL Sylhet">Sylhet</option>
									<option value="Rangpur" data-subtext="RNP" data-tokens="RNP Rangpur">Rangpur</option>
									<option value="Dewanganj" data-subtext="DWG" data-tokens="DWG Dewanganj">Dewanganj</option>
									<option value="Khulna" data-subtext="KLN" data-tokens="KLN Khulna">Khulna</option>
									<option value="Lalmonirhat" data-subtext="LAL" data-tokens="LAL Lalmonirhat">Lalmonirhat</option>
									<option value="Nilphamari" data-subtext="NLP" data-tokens="NLP Nilphamari">Nilphamari</option>
				...
				<div class="footer col-sm-12">
					...
					<div class="col-sm-4">
						...
						<div class="footerText">
							Gulshan<br> Dhaka, Bangladesh
						</div>
				
						<div class="footerText">
							E-mail: tahsin@EZTripBD.com
						</div>
					...
					<div class="col-sm-4">
						...
						<div class="socialLinks">
							...
							<div class="fb">
								facebook.com/EzTripBD
							</div>
						
							<div class="gp">
								plus.google.com/EzTripBD
							</div>
						
							<div class="tw">
								twitter.com/EzTripBD
							</div>
						
							<div class="in">
								linkedin.com/EzTripBD
							</div>
					...
					<div class="copyrightContainer">
						<div class="copyright">
						Copyright &copy; 2024 @ Tahsin Munni pinky joy
						</div>
					</div>
					</div>
