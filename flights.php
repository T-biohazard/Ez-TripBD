   							...
   							<div class="form-group">
   								 <label for="origin">Origin:<p> </p></label>
      								...
      								<select id= "origin"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin" name="origin" required>
       									...
       									<option value="Coxs Bazar" data-subtext="CXB" data-tokens="CXB Coxs Bazar">Cox's Bazar</option>
   							...
   							<div class="form-group">
   								 <label for="destination">Destination:<p> </p></label>
      								...
      								<select id= "destination"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination" name="destination" required>
       									...
       									<option value="Coxs Bazar" data-subtext="DEL" data-tokens="CXB Coxs Bazar">Cox's Bazar</option>
        								<option value="Dhaka" data-subtext="DAC" data-tokens="DAC Dhaka">Dhaka</option>				
        								<option value="Rajshahi" data-subtext="RAJ" data-tokens="RAJ Rajshahi">Rajshahi</option>
        								<option value="Sylhet" data-subtext="ZYL" data-tokens="ZYL Sylhet">Sylhet</option>
