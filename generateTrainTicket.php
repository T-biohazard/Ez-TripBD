			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<div class="info">
						...
						<span class="strong">3.</span> It is mandatory to carry Government recognised photo identification (ID) along with your E-Ticket. This can include: Driving License, Passport, PAN Card, Voter ID Card or any other ID issued by Tahsin. For infant passengers, it is mandatory to carry the Date of Birth certificate.
